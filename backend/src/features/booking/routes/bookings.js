...
// Unused booking routes removed (GET /, GET /:id, POST /:id/cancel)
// These routes are not currently used by the frontend
// Only /create and OAuth callback routes are actively used
